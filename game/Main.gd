...
func _on_loading_finished():
	print("Loading screen finished - game is ready!")
	# The loading screen will remove itself
	loading_screen = null
...
func _draw():
	...
	var heart_pos = end_1 + Vector2(BORDER_WIDTH - 1, BORDER_WIDTH - 1)
	var heart_rect = Rect2(heart_pos * CELL_SIZE, Vector2(45, 45))
	draw_texture_rect(heart_img, heart_rect, false)
	
	var brain_pos = end_2 + Vector2(BORDER_WIDTH - 1, BORDER_WIDTH - 1)
