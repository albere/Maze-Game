...
ARG GODOT_MINIZIP="no"
ARG GODOT_MODULE_FREETYPE_ENABLED="yes"
ARG GODOT_MODULE_OGG_ENABLED="yes"
ARG GODOT_MODULE_VORBIS_ENABLED="yes"
ARG GODOT_MODULE_WEBM_ENABLED="no"
ARG GODOT_MODULE_BULLET_ENABLED="no"
ARG GODOT_MODULE_CSG_ENABLED="no"
ARG GODOT_MODULE_GRIDMAP_ENABLED="no"
ARG GODOT_MODULE_MOBILE_VR_ENABLED="no"
ARG GODOT_MODULE_CAMERA_ENABLED="no"
ARG GODOT_MODULE_LIGHTMAP_ENABLED="no"
ARG GODOT_MODULE_RAYCAST_ENABLED="no"
ARG GODOT_MODULE_VHACD_ENABLED="no"
ARG GODOT_MODULE_XATLAS_UNWRAP_ENABLED="no"
ARG GODOT_MODULE_3D_ENABLED="no"
ARG GODOT_MODULE_ARKIT_ENABLED="no"
ARG GODOT_MODULE_ASSIMP_ENABLED="no"
ARG GODOT_MODULE_DDS_ENABLED="no"
ARG GODOT_MODULE_GLTF_ENABLED="no"
ARG GODOT_MODULE_HDR_ENABLED="no"
ARG GODOT_MODULE_SVG_ENABLED="yes"
ARG GODOT_MODULE_TGA_ENABLED="no"
ARG GODOT_MODULE_THEORA_ENABLED="yes"
ARG GODOT_MODULE_TINYEXR_ENABLED="no"
ARG GODOT_MODULE_WEBP_ENABLED="no"
ARG GODOT_MODULE_ENET_ENABLED="no"
ARG GODOT_MODULE_JSONRPC_ENABLED="no"
ARG GODOT_MODULE_MBEDTLS_ENABLED="no"
